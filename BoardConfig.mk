...
# Restrict dexpreopt to boot image + system_server only (skip per-app preopt).
# Avoids the persistent failure where frameworks/base/ext tries to dexpreopt
# against a boot.art that isn't getting generated by our minimal config.
WITH_DEXPREOPT := true
